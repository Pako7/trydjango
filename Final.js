...
class ServiceForm extends Component{
    constructor(props){
        ...
        //pp
        this.serviceFeeAmountFormated = this.serviceFeeAmountFormated.bind(this);
    ...
    //pp
    serviceFeeAmountFormated(){
        let value = '';

        if(this.state.service_fee_amount.amount_1 || 
            this.state.service_fee_amount.amount_2 ||
            this.state.service_fee_amount.amount_3){
            ...
            this.setState(function (prevState) {
                return {
                    data: {
                        ...prevState.data,
                        //pp
                        service_fee_amount: this.serviceFeeAmountFormated(),
                    },
                };
            });
        });
    ...
    SaveModelForm(){
        this.state.data.service_fee_amount = this.serviceFeeAmountFormated();
    ...
    reset(id){
        if (id !== null){
            ...
            .then(res => {
                ...
                if(service_fee_amount_array[0]){
                    this.state.service_fee_amount.amount_1 =  parseFloat(service_fee_amount_array[0]);
                }
                if(service_fee_amount_array[1]){
                    this.state.service_fee_amount.amount_2 =  parseFloat(service_fee_amount_array[1]);
                  }
                if(service_fee_amount_array[2]){
                    this.state.service_fee_amount.amount_3 =  parseFloat(service_fee_amount_array[2]);
                }
/*
                ...
                */
                this.setState(
                    ...
                    return {
                        ...
                        data:res.data,
                        //pp
                        service_fee_amount: this.state.service_fee_amount,
                        modal_properties: {
                            ...prev_State.modal_properties,
    ...
    options_load(){
        ...
        axios.get(`${ApiUrl}general/services/?no_service_fee=true&limit=5000`)
        .then(res => {
            this.setState({
